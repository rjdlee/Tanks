...
import Player from 'entity/tank';
import Bullet from 'entity/bullet';
import Score from 'entity/score';
import Snapshot from 'entity/snapshot';
import SnapshotList from 'entity/snapshot_list';
...
function Map( width = 1960, height = 1080 )
{
...
Map.prototype.saveSnapshot = function ()
{
	var players = {},
		projectiles = {},
		walls = {};
...
Map.prototype.loadSnapshot = function ( timestamp )
{
	this.saveSnapshot();
...
Map.prototype.replaySnapshot = function ()
{
...
Map.prototype.diffSnapshot = function ( snapshot, prevSnapshot )
{
	var diff = {},
		players,
		projectiles,
...
Map.prototype.kill = function ( victimID, murdererID )
{
...
Map.prototype.spawn = function ( playerID )
{
	var player,
		tries = 0;
