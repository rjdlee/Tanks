...
function Connect() {
  ...
  this.socket.on('connect_error', function() {
    if (this.socket.io.uri === 'http://localhost:8888')
      this.socket.io.uri = 'https://tank.rjdlee.com';
    else
...
function connectHandler(data) {
  ...
  for (var id in data.projectiles) {
    ...
    projectiles.push(new Projectile(projectile.pid, projectile.pos.x, projectile.pos.y, projectile.angle
      .rad, projectile.speed));
  }
